  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        muted: 'var(--surface-muted, var(--theme-surface))',
        'muted-foreground': 'var(--theme-muted)',
        border: 'var(--theme-border)',
        input: 'var(--theme-border)',
        ring: 'var(--accent-color, #3b82f6)',
        accent: 'var(--surface-muted, var(--theme-surface))',
        'accent-foreground': 'var(--theme-text)',
        secondary: 'var(--surface-muted, var(--theme-surface))',
