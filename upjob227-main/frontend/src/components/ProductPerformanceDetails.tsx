...
// FLOW START: Product Performance Details Page (EN)
// จุดเริ่มต้น: หน้า Product Performance Details (TH)
        ...
        <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
          ...
          {!loading && filteredAndSortedProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 text-sm mt-2">If you just seeded data, ensure metrics metadata contains product fields (e.g. productName).</p>
            </div>
          )}
        </div>
...
// FLOW END: Product Performance Details Page (EN)
// จุดสิ้นสุด: หน้า Product Performance Details (TH)
